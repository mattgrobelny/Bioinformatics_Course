...
hits_gene_list = []
for value in cursor_s12.fetchall():
...
for gene_id in hits_gene_list[0:20]:
    ...
    cursor_gene_db.execute(gene_id_to_actual_gene_id, (gene_id))
    gene_name = cursor_gene_db.fetchall()

    # Query blast hit
    cursor_s12.execute(query_blast_out, (gene_id))
    blast_hit = cursor_s12.fetchall()
